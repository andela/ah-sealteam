"""
Test parameters and helper functions to be used with social auth
credit: django-rest-auth git repository
"""
...
class TestsMixin(object):
    ...
    def init(self):
        ...
        self.fb_login_url = reverse('authentication:fb_login')
        self.tw_login_url = reverse('authentication:tw_login')
        self.fb_connect_url = reverse('authentication:fb_connect')
        self.tw_connect_url = reverse('authentication:tw_connect')
        self.social_account_list_url = reverse('authentication:social_account_list')
